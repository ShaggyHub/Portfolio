...
import { FiDribbble, FiFacebook, FiGithub, FiInstagram, FiLinkedin } from 'react-icons/fi';
    ...
    <div className="hero relative -mt-16 flex items-center justify-center">
      ...
      <div className="flex flex-col items-center">
        <div className="overflow-hidden rounded-full">
          <Image src="images/avatar/man.png" width={180} height={180} alt="avatar" unoptimized/>
        </div>
        <h1 className="mt-4 text-3xl font-bold ">SAGAR DHANPAL KHOKAD123</h1>
        ...
        <div className="mt-4  flex gap-5">
          <Link href="https://www.instagram.com/its_me_shaggy__?igsh=MWM0cnJhcGpqaXMxdQ==">
            <a className="text-gray-700 transition-colors duration-150 hover:text-primary-500">
              <FiInstagram size={25} />
            </a>
          </Link>
          <Link href="https://www.linkedin.com/in/sagar-khokad-163471294/">
            <a className="text-gray-700 transition-colors duration-150 hover:text-primary-500">
              <FiLinkedin size={25} />
            </a>
          </Link>
          ...
          <Link href="https://github.com/ShaggyHub">
            <a className="text-gray-700 transition-colors duration-150 hover:text-primary-500">
              <FiGithub size={25} />
            </a>
          </Link>
