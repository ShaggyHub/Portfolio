      ...
      <div className="grid grid-cols-1 gap-6 py-6 md:grid-cols-2 lg:gap-8">
        ...
        <div className="">
          <p className="text-justify">
            Hi, I am Sagar Khokad, I am a fullstack developer. I work from Pune, India. I have rich
            experience in building, designing & customizing website etc.
          </p>
        ...
        <div className="grid grid-cols-2 gap-x-6 gap-y-4">
          ...
          <div className="">
            <div className="mb-3 flex justify-between">
              <h6 className="font-semibold">Bootstrap</h6>
              <p>75%</p>
            </div>
